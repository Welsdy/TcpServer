...
#ifndef TCPSERVER_HTTP_SERVER_H
#define TCPSERVER_HTTP_SERVER_H
...
typedef int (*request_callback)(struct http_request *httpRequest,struct http_reponse *httpReponse);
